...
public class Ex03_ThreadSwing extends JFrame implements ActionListener{
	...
	public Ex03_ThreadSwing(String title) {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex03_ThreadSwing a=new Ex03_ThreadSwing("스레드예제");
