...
<body>
	<table class="table" style="width: 500px; border: none; margin: 20px;">
		<tr>
			<th colspan="2">${dto.subject }</th>
		</tr>
		<tr>
			<th>${dto.writer }</th>
			<td rowspan="2" align="right" valign="middle"><fmt:formatDate
		...
		<tr>
			<td width="200"><img
				src="../image/snoopyAvata/s${dto.avatar }.JPG"
