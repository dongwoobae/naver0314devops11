...
import="data.dto.MemoDao"%> <%@page import="data.dao.MemoDto"%> <%@ page
...
<html>
  ...
  <% int num=Integer.parseInt(request.getParameter("num")); MemoDao dao=new
  MemoDao(); MemoDto dto=dao.getData(num); SimpleDateFormat sdf = new
